...
class AppColors {
  ...
  static const Color cream = Color(0xFFF6F0E5);
  static const Color background = Color(0xFFFFFFFF);
  static const Color backgroundOff = Color(0xFFF6F0E5);
  static const Color surface = Color(0xFFFFFFFF);
  static const Color neutral = Color(0xFF5A6B66);
  static const Color textPrimary = Color(0xFF10231D);
  static const Color textSecondary = Color(0xFF5A6B66);

  static const Color income = Color(0xFF10A474);
  static const Color expense = Color(0xFFC0392B);
  static const Color success = Color(0xFF10A474);
  static const Color danger = Color(0xFFC0392B);
  static const Color warning = Color(0xFFD9A93B);
}
