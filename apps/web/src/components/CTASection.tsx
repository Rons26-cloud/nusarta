    ...
    <section aria-labelledby="download-heading" className="border-y border-border bg-muted py-16 lg:py-24">
      <div className="mx-auto grid w-full max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        <div className="min-w-0 max-w-xl">
          ...
          <DownloadLink href={downloadUrl ?? "/download"} download={downloadUrl ? currentRelease.apkFileName : undefined} className="mt-7 inline-flex min-h-12 w-full max-w-xs items-center justify-center gap-2 rounded-full bg-nusa-gold px-6 py-3 text-sm font-semibold text-nusa-deepest transition-colors hover:bg-nusa-goldlight sm:w-auto sm:text-base">
